...
public class Student {
    ...
    public void dersEkle(Lesson ders){//propertisleri kullandığı için normal metoddur.
        ...
        if (suanToplamSaat+ders.saat<=maxSaat){
            ...
            System.out.println(ders.lessonName+": Kredi sınırı aşıldı");
        }
    }
    ...
    public void dersleriYazdir(){
        ...
        for (Lesson d:dersleri) {
            System.out.println(d.lessonName+" "+d.saat);
        }
    }
